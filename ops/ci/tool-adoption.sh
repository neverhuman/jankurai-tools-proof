...
fixture_command="CARGO=$governed_cargo CARGO_HOME=/home/ubuntu/.cargo RUSTC=$governed_rustc RUSTUP_HOME=/home/ubuntu/.rustup $governed_llvm_cov --manifest-path Cargo.toml --locked --offline --lcov --output-path target/jankurai/coverage.lcov"
/usr/bin/printf \
...
/usr/bin/git -C "$adoption_root" add Cargo.lock Cargo.toml agent src/lib.rs
