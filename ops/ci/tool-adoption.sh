...
jankurai_run audit . --mode ratchet --baseline target/jankurai/accepted-baseline.json --json target/jankurai/repo-score.json --md target/jankurai/repo-score.md
...
jankurai_run proofbind verify . --changed-from origin/main
...
jankurai_run proofmark rust . --obligations target/jankurai/proofbind/obligations.json
...
jankurai_run security run . --out target/jankurai/security/evidence.json
